...
/**
 * View class for a list of Paymybill.
 *
 * @since  1.6
 */
class PaymybillViewPayments extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		PaymybillHelper::addSubmenu('payments');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_PAYMYBILL_TITLE_PAYMENTS'), 'payments.png');
		...
		{
			JToolBarHelper::preferences('com_paymybill');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_paymybill&view=payments');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`order_id`' => JText::_('COM_PAYMYBILL_PAYMENTS_ORDER_ID'),
			'a.`status`' => JText::_('COM_PAYMYBILL_PAYMENTS_STATUS'),
			'a.`payment`' => JText::_('COM_PAYMYBILL_PAYMENTS_PAYMENT'),
			'a.`BillFname`' => JText::_('COM_PAYMYBILL_PAYMENTS_BILLFNAME'),
			'a.`BillLname`' => JText::_('COM_PAYMYBILL_PAYMENTS_BILLLNAME'),
			'a.`BillAddr`' => JText::_('COM_PAYMYBILL_PAYMENTS_BILLADDR'),
			'a.`BillEmail`' => JText::_('COM_PAYMYBILL_PAYMENTS_BILLEMAIL'),
			'a.`BillPhone`' => JText::_('COM_PAYMYBILL_PAYMENTS_BILLPHONE'),
			'a.`InvNr`' => JText::_('COM_PAYMYBILL_PAYMENTS_INVNR'),
			'a.`cdate`' => JText::_('COM_PAYMYBILL_PAYMENTS_CDATE'),
			'a.`mdate`' => JText::_('COM_PAYMYBILL_PAYMENTS_MDATE'),
		);
	}
