...
function pmbGetPopupContent(obj)
{
  ...
  content+='<div width="100%" class="pmb_popup_tbl">';

    content+='<div class="pmb_popup_row row"><div class="col-md-6"><div class="form-group">';
  ...
  if(obj.show_tos==1)
  {
    ...
    {
        content+='<div class="pmb_popup_row row"><div class="col-md-12"><div class="form-group">';
        content+='<label for="pmbInvID'+obj.id+'" class="pmb_popup_lbl control-label formControlLabel">'+obj.invoice_text+'</label>';
        content+='<div class="formControls">';
  ...
  content+='<div class="pmb_popup_submit_row">';
  content+='<div class="formControls">';
